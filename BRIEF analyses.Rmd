...
#### Comparing SES across Language Group
```{r}
...
#### Comparing Age across Language Group
```{r}
...
CHECK HOW MANY WE HAVE age of onset deafness, cause of deafness, and age of first CI implantation
  IF not missing too many, ADD TO TABLE 3
